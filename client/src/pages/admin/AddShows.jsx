...
const AddShows = () => { 
  ...
  return nowPlayingMovies.length > 0 ? (
    <>
      ...
      <div className='overflow-x-auto pb-4'>
        <div className='group flex flex-wrap gap-4 mt-4 w-max'>
          {nowPlayingMovies.map((movie)=>(
            ...
            <div 
              key={movie.id} 
              className={`relative max-w-40 cursor-pointer group-hover:not-hover:opacity-40 hover:!opacity-100 hover:-translate-y-1 transition duration-300`}
      ...
      {/* Display Selected Date/Times (Optional) */}
      {Object.keys(dateTimeSelected).length > 0 && (
        <div className="mt-4">
          <p className="text-sm font-medium mb-2">Selected Showtimes:</p>
