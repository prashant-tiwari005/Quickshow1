...
const MovieDetails = () => {
  ...
  return show ? (
    <div className='px-6 md:px-16 lg:px-40 pt-24 md:pt-32'>
      ...
      <p className='text-lg font-medium mt-20'>You might also like</p>
      ...
      <div className='flex justify-center mt-20'>
        <button onClick={() => {navigate('/movies'); scrollTo (0,0)}} className='px-10 py-3 text-sm bg-gray-800 hover:bg-gray-900 transition rounded-md font-medium cursor-pointer active:scale-95'>
          Show More
        </button>
